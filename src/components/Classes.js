...
import ballet2Sm from "../assets/classesPage/balletII-300.jpeg";
import ballet2Md from "../assets/classesPage/balletII-768.jpeg";
import ballet2Lg from "../assets/classesPage/balletII-1280.jpeg";
import ballet2XL from "../assets/classesPage/balletII-2000.jpeg";
import ballet2SmWebp from "../assets/classesPage/balletII-300.webp";
import ballet2MdWebp from "../assets/classesPage/balletII-768.webp";
import ballet2LgWebp from "../assets/classesPage/balletII-1280.webp";
import ballet2XLWebp from "../assets/classesPage/balletII-2000.webp";
...
function Classes() {
  ...
  var classInfo = {
    ...
    flexibility: {
      ...
      classSched3: "FRIDAY",
      classSched4: "5:00 PM - 6:00 PM",
      classSched5: "SATURDAY",
      classSched6: "10:00 AM - 11:00 PM",
      classDesc:
  ...
  const setClassInfo = (curClass) => {
    ...
    document.getElementById("cur-class-sched5").innerHTML =
      classInfo[curClass].classSched5;
    document.getElementById("cur-class-sched6").innerHTML =
      classInfo[curClass].classSched6;
      ...
      <div className="right-info">
        ...
        <div className="class-desc-box">
          ...
          <div className="class-schedule">
            ...
            <p id="cur-class-sched5">{classInfo.preBallet1.classSched5}</p>
            <p id="cur-class-sched6">{classInfo.preBallet1.classSched6}</p>
